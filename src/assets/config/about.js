export const about = {
    web: {
        desc: [
            ...
            "I Started to learn frontend with html css js at the same time I started to get interested in different builders such as Gulp and Webpack, made my own builds for development with different preprocessors for html and css, site optimisation and more.",
